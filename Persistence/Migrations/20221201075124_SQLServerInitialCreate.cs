        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleToRelease = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    ReconfigurationStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProdLine = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Organization = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParentJob = table.Column<int>(type: "int", nullable: true),
                    HotOrder = table.Column<bool>(type: "bit", nullable: false),
                    HelpRequiredFrom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderSplitChildWOCreated = table.Column<bool>(type: "bit", nullable: false),
                    AdditionalComments = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrderProcessingLine = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseOfAction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrderHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderHistories_UserId",
